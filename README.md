...
- **Skins de nave**: pulsa `C` para ciclar entre 5 apariencias distintas (forma y color, incluida la llama del propulsor). La selección se guarda en `localStorage` y los iconos de vidas reflejan la skin activa. La skin **Titán** es morada, mide el doble que las demás y otorga el doble de puntos (`PUNTOS x2` en el HUD).
